# -*- coding: utf-8 -*-
"""
Created on Fri May 31 12:13:09 2019
...
data = pd.merge(stock, sector.drop(['code'],axis=1), on = 'name', how = 'left')
...
for m in market:
    ...
    for name, group in sector:
        ...
        for n in sectorList:
            ...
            #export to csv file
            df_new.to_csv('pivot_table' + '/' + filename)

##### part 5 : correlation analysis
data2 = os.listdir('pivot_table')
os.chdir('pivot_table')
corrList = []
nameList1= []

for df in data2:
    #read csv
    data3 = pd.read_csv(df)
